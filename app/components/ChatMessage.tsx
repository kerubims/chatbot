      ...
      <div className="chat-bubble-assistant relative">
        ...
        {!isStreaming && (
          <button
            ...
            className="absolute -right-11 top-1/2 -translate-y-1/2 p-2 rounded-full text-white/50 hover:text-white hover:bg-white/10 transition-colors opacity-100 md:opacity-0 md:group-hover/message:opacity-100 active:scale-95 flex items-center justify-center backdrop-blur-sm"
          >
            {isTranslating ? (
